...
import MetamaskIcon from "@/assets/images/wallets/metamask.jpg";
import BinanceWalletIcon from "@/assets/images/wallets/binance.png";
...
import MyKeyWalletIcon from "@/assets/images/wallets/mykey.jpg";
import AtomicWalletIcon from "@/assets/images/wallets/atomic.jpg";
import CoolWalletIcon from "@/assets/images/wallets/cool_wallet_s.jpg";
...
export const WALLETS = [
  ...
  },
  {
    name: "Saito pro",
    link: "saitopro.com",
    icon: SaitoProWalletIcon,
  },
  {
    name: "Walleth",
    link: "walleth.org",
    icon: WallethWalletIcon,
  },
  {
    name: "Saitomask",
    link: "saitomask.org",
    icon: SaitoMaskWalletIcon,
  },
  {
    name: "Argent",
    link: "argent.xyz",
  ...
  },
  {
    name: "1inch",
    link: "1inch.io",
    icon: OneInchWalletIcon,
  },
  {
    name: "Dharma",
    link: "dharma.io",
    icon: DharmaWalletIcon,
  },
  {
    name: "Trust Vault",
    link: "trustology.io",
    icon: TrustVaultWalletIcon,
  },
  {
    name: "MYKEY",
    link: "mykey.org",
    icon: MyKeyWalletIcon,
  },
  {
    name: "Atomic",
